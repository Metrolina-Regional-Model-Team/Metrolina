TITLE				            Metrolina HBO PEAK Mode Choice

PROJECT_DIRECTORY	            ALT_DIR
NUMBER_OF_THREADS	            1													
									
TRIP_TABLE_FILE                 TripTables\HBO_PEAK_TRIPS.mtx		
...
NEW_TRIP_TABLE_FILE			    ModeSplit\HBO_PEAK_MS.mtx
NEW_TRIP_TABLE_FORMAT     	    TRANSCAD
SELECT_TRIP_TABLES              INCOME1, INCOME2, INCOME3, INCOME4						//---- Cores in Trip Tables ----

MODE_CONSTANT_FILE	            ModeSplit\INPUTS\HBO_PEAK_Constant.txt			
MODE_BIAS_FILE	            	ModeSplit\INPUTS\HBO_PEAK_Bias.txt
...
##CALIBRATION_TARGET_FILE			ModeSplit\INPUTS\Targets\HBO_Target_PEAK.txt
##CALIBRATION_SCALING_FACTOR		1.0
##MAX_CALIBRATION_ITERATIONS		10
##CALIBRATION_EXIT_RMSE		    0.1
##NEW_MODE_CONSTANT_FILE			ModeSplit\Results\HBO_PEAK_Constant_New.txt						
##NEW_CALIBRATION_DATA_FILE	    ModeSplit\Results\HBO_PEAK_Data.txt							
...
NEW_MODE_SUMMARY_FILE           ModeSplit\Results\ALTNAME_HBO_PEAK_Summary.txt
NEW_MARKET_SEGMENT_FILE         ModeSplit\Results\ALTNAME_HBO_PEAK_Segment.txt
##NEW_MODE_SEGMENT_FILE           ModeSplit\Results\HBO_Mode_Seg.txt
##NEW_FTA_SUMMIT_FILE		      ModeSplit\Results\HBO_Summit.bin
NEW_PRODUCTION_FILE		        ModeSplit\Results\ALTNAME_HBO_PEAK_Productions.txt
NEW_ATTRACTION_FILE		        ModeSplit\Results\ALTNAME_HBO_PEAK_Attractions.txt
