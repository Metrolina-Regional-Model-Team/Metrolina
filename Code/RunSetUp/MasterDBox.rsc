Dbox "MasterDBox" center, center Title: "Metrolina Regional Model: MRM19v1.0"
	Init do
	...
	//Trip Model
		...
		runpostfeedbackjobs = {"TDMatrixStats",
	 	...
	 	runtranassnjobs = {"Transit_Input", 
 				...
 				"Transit_Pax_Stats", "Transit_Operations_Stats", "Transit_Boardings", "Transit_RunStats"}
...
// 	MRMDir		MRM Directory 		  
	...
	Text " " same, after, , 0.5
	Edit Text "mrmdir" 15.5, after, 30 Prompt: "MRM Directory:" Variable: MRMUser Help:"Master MRM Directory (e.g. L:\\MRM19v1.0)" 
...
//	Create new directory
	...
	Text " " same, after, , 0.5
	Button " Create Trips Dir " 15.5, after, 16 Disabled Help: "Create a new run directory for trips (4 step) model " do
		modeltype = "Trip"
		CreateDirectory = 1
		RunMacro("GetDir")
		if DirExist = 1
