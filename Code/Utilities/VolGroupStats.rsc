...
{"LinksCount", "Integer", 10, , "No"}, {"CALIB", "Real", 10, 2, "No"}, {"TOT_VOL", "Real", 12, 2, "No"}, {"CNTMCSQ", "Real", 8, 2, "No"}, {"TOT_VMT", "Real", 8, 2, "No"},
...
volgroup_tab = CreateTable("volgroup_tab", Dir + "\\volgroup_tab.bin", "FFB", {{"STCNTY", "Integer", 5, , "No"}, {"VolGrpID", "Integer", 2, , "No"},
	{"LinksCount", "Integer", 10, , "No"}, {"Length", "Real", 21, 4, "No"}, {"CALIB", "Real", 21, 4, "No"}, {"Tot_Vol", "Real", 21, 4, "No"}, {"CNTMCSQ", "Real", 21, 4, "No"}, {"TOT_VMT", "Real", 21, 4, "No"},
	...
	volgroup_ar = { 0, 1000, 2500, 5000, 10000, 25000, 50000, 1000000 }
		...
		volgroup_tab2 = ExportView("volgroup_tab|", "CSV", Dir + "\\VolGroupStats.csv",{"STCNTY", "VolGrpID", "LinksCount", "Length", "CALIB", "Tot_Vol", "CNTMCSQ", "TOT_VMT", "TOT_VHT"}, { {"CSV Header", "True"} } )		
