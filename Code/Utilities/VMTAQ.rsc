...
//Open files
	...
	VMTAQ =  JoinViews("VMTAQ", "FUNAQID.FUNAQ", "TotAssn.FEDFUNC_AQ", 
        	           {{"A",}, 
    			    {"Fields",{{"CNTFLAG", {{"Sum"}}}, {"CALIB", {{"Sum"}}}, {"VMT_AM",  {{"Sum"}}}, {"VHT_AM", {{"Sum"}}}, {"VMT_PM", {{"Sum"}}}, {"VHT_PM", {{"Sum"}}},  		       
	...
	runstats_VMTAQ = ExportView("VMTAQ|", "CSV", Dir + "\\report\\runstats_VMTAQ.csv", 
		{"ORDER", "FUNAQ", "FUNAQID.COUNTY", "[N TotAssn]", "LENGTH", "CNTFLAG", "CALIB", "VMT_AM", "VHT_AM", "VMT_PM", "VHT_PM", "VMT_MI", "VHT_MI", "VMT_NT", "VHT_NT", "TOT_VMT", "TOT_VHT"}, { {"CSV Header", "True"} } )
