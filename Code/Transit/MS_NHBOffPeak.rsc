Macro "MS_NHBOffPeak" (Args)

// Macro to call NHB_OffPeak Modechoice ONLY - Not a part of standard conformity run (Conformity run uses MS_OffRunPeak)
	...
	AppendToLogFile(1, "Enter MS_NHBOffPeak, NHB OffPeak ONLY: " + datentime)
...
// post process matrices
	...
	datentime = GetDateandTime()
	AppendToLogFile(1, "Exit MS_NHBOffPeak: " + datentime)
