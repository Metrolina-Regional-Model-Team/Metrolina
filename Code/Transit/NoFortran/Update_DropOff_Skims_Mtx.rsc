...
/////////////////////////////////////////////////////////////////////////////////////////////////////
//	replace call to Fortran UPD_DA_Dist_Time_Costv1.exe 
//		with Update_DropOff_KNR_Skims
//  McLelland - 12/5/ 19	This version takes a lot longer
/////////////////////////////////////////////////////////////////////////////////////////////////////

	m1File = Dir + "\\Skims\\"+time_period+transit_mode+"_DODist.MTX"
	if (time_period="peak") then do
		m2File = Dir + "\\Skims\\skim_knr_peak.mtx"
		m3File = Dir + "\\Skims\\skim_pnr2dest_peak_prm.mtx"
	end // time period = peak
	else if (time_period="offpeak") then do
		m2File = Dir + "\\Skims\\skim_knr_offpeak.mtx"
		m3File = Dir + "\\Skims\\skim_knr2dest_offpeak.mtx"
	end // time period = offpeak
	
	datentime = GetDateandTime()
	AppendToLogFile(2, "Update_Dropoff_Skims - Enter Update KNR skims: "  + datentime)

	RunMacro("Update_DropOff_KNR_Skims", m1File, m2File, m3File)

	datentime = GetDateandTime()
	AppendToLogFile(2, "Update_DropOff_Skims - Exit Update KNR skims: "  + datentime)

/////////////////////////////////////////////////////////////////////////////////////////////////////
//	comment out fortran call - replace with call to Update_Dropoff_KNR_Skim   (above)
//  McLelland - 12/9/ 19
/////////////////////////////////////////////////////////////////////////////////////////////////////
