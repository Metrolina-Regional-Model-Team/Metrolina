...
//   ret_value = RunMacro("TCB Run Procedure", 1, "Transit Assignment SP", Opts)  
	...
	badbuildtrannet:
	Throw("PBusW_Assign - Error return build transit network")
	AppendToLogFile(1, "PBusW_Assign - Error return build transit network") 
	goto badquit

	badtransettings:
	Throw("PBusW_Assign - Error return from transit network settings")
	AppendToLogFile(1, "PBusW_Assign - Error return from transit network settings") 
	goto badquit

	badtranassn:
	Throw("PBusW_Assign - Error return from transit network skims")
	...
	Throw(rtnmsg)
	AppendToLogFile(2, rtnmsg)
	Throw("PBusW_Assign - Error return from XPR_StopFlags")
