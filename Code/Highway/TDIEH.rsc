Macro "TDIEH" (Args)
	...
	//Trip Distribution - Internal - external - heavy trucks
	...
	AppendToLogFile(1, "Enter TDieh: " + datentime)
	...
	CopyMatrixStructure({templatecore}, {{"File Name", Dir + "\\TD\\TDieh.mtx"},
		{"Label", "TDieh"},
		{"File Based", "Yes"},
		{"Tables", {"Trips"}},
		{"Operation", "Union"}})
	...
	//TDMET control file
	ctlname = METDir + "\\Pgm\\Param\\TDieh.ctl"
	...
	WriteLine(ctlhandle, "TDieh.set: I/E HTK")
	WriteLine(ctlhandle, " ")
	...
	WriteLine(ctlhandle, " ")
	WriteLine(ctlhandle, "&files")
	WriteLine(ctlhandle, "  ffactors = '" + METDir + "\\Pgm\\Frictionfactors\\ffieh.prn'")
	...
	WriteLine(ctlhandle, "  trips    = '" + Dir + "\\TD\\TDieh.mtx'")
	WriteLine(ctlhandle, "  listing  = '" + Dir + "\\Report\\TDieh.txt'")
	...
	WriteLine(ctlhandle, "  tformat    = '(i10,i10,240x,f10.3)'")
	...
	if (exist <> null) then DeleteFile(ctlname)
	ctlhandle = OpenFile(ctlname, "w")
	WriteLine(ctlhandle, METDir + "\\Pgm\\tdmet_mtx.exe " + METDir + "\\Pgm\\Param\\TDieh.ctl")
	CloseFile(ctlhandle)
	...
	quit:
	datentime = GetDateandTime()
	AppendToLogFile(1, "Exit TDieh: " + datentime)
