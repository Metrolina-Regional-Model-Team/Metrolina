Macro "TOD1_HBO_Peak" (Args)
	...
	AppendToLogFile(1, "Enter TOD1_HBO_Peak: " + datentime)
	...
	CopyMatrixStructure({templatecore}, {{"File Name", Dir + "\\TripTables\\HBO_PEAK_TRIPS.mtx"},
		{"Label", "hbo_peak_person"},
		{"File Based", "Yes"},
	...
	PM = OpenMatrix(Dir + "\\TripTables\\HBO_PEAK_TRIPS.mtx", "True")
	...
	c3 = CreateMatrixCurrency(PM, "INCOME1", "Rows", "Columns",)

	MatrixOperations(c3, {c1,c2}, {0.4797,0.4261},,, {{"Operation", "Add"}, {"Force Missing", "No"}})
	...
	c1 = CreateMatrixCurrency(FM1, "Trips", "Rows", "Columns",)
	c2 = CreateMatrixCurrency(FM2, "Trips", "Rows", "Columns",)
	c3 = CreateMatrixCurrency(PM, "INCOME2", "Rows", "Columns",)
	...
	c1 = CreateMatrixCurrency(FM1, "Trips", "Rows", "Columns",)
	c2 = CreateMatrixCurrency(FM2, "Trips", "Rows", "Columns",)
	c3 = CreateMatrixCurrency(PM, "INCOME3", "Rows", "Columns",)
	...
	c1 = CreateMatrixCurrency(FM1, "Trips", "Rows", "Columns",)
	c2 = CreateMatrixCurrency(FM2, "Trips", "Rows", "Columns",)
	c3 = CreateMatrixCurrency(PM, "INCOME4", "Rows", "Columns",)
	...
	// zero fill matrices
		...
		Opts = null
		Opts.Input.[Matrix Currency] = {Dir + "\\TripTables\\HBO_PEAK_TRIPS.mtx", "INCOME1", "Rows", "Columns"}
	...
	if !ret_value then goto badfill
		...
		Opts = null
		Opts.Input.[Matrix Currency] = {Dir + "\\TripTables\\HBO_PEAK_TRIPS.mtx", "INCOME2", "Rows", "Columns"}
		Opts.Global.Method = 11
		Opts.Global.[Cell Range] = 2
	...
	if !ret_value then goto badfill
		...
		Opts = null
		Opts.Input.[Matrix Currency] = {Dir + "\\TripTables\\HBO_PEAK_TRIPS.mtx", "INCOME3", "Rows", "Columns"}
		Opts.Global.Method = 11
		Opts.Global.[Cell Range] = 2
	...
	if !ret_value then goto badfill
		...
		Opts = null
		Opts.Input.[Matrix Currency] = {Dir + "\\TripTables\\HBO_PEAK_TRIPS.mtx", "INCOME4", "Rows", "Columns"}
		Opts.Global.Method = 11
		Opts.Global.[Cell Range] = 2
	...
	badfill:
	TOD1OK = 0
	msg = msg + {"TOD1_HBO_Peak - zero fill matrix failed"}
	...
	datentime = GetDateandTime()
	AppendToLogFile(1, "Exit TOD1_HBO_Peak: " + datentime)
	return({TOD1OK, msg})
