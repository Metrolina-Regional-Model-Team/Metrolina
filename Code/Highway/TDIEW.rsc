Macro "TDIEW" (Args)
	...
	//Trip Distribution - Internal - external - work trips	
	...
	AppendToLogFile(1, "Enter TDiew: " + datentime)
	...
	CopyMatrixStructure({templatecore}, {{"File Name", Dir + "\\TD\\TDiew.mtx"},
		{"Label", "TDiew"},
		{"File Based", "Yes"},
		{"Tables", {"Trips"}},
		{"Operation", "Union"}})
	...
	//TDMET control file
	ctlname = METDir + "\\Pgm\\Param\\TDiew.ctl"
	...
	WriteLine(ctlhandle, "TDiew.set: I/E Work Auto")
	WriteLine(ctlhandle, " ")
	...
	WriteLine(ctlhandle, " ")
	WriteLine(ctlhandle, "&files")
	WriteLine(ctlhandle, "  ffactors = '" + METDir + "\\Pgm\\Frictionfactors\\ffiew.prn'")
	...
	WriteLine(ctlhandle, "  trips    = '" + Dir + "\\TD\\TDiew.mtx'")
	WriteLine(ctlhandle, "  listing  = '" + Dir + "\\Report\\TDiew.txt'")
	...
	WriteLine(ctlhandle, "  tformat    = '(i10,i10,200x,f10.3)'")
	...
	if (exist <> null) then DeleteFile(ctlname)
	ctlhandle = OpenFile(ctlname, "w")
	WriteLine(ctlhandle, METDir + "\\Pgm\\tdmet_mtx.exe " + METDir + "\\Pgm\\Param\\TDiew.ctl")
	CloseFile(ctlhandle)
	...
	quit:
	datentime = GetDateandTime()
	AppendToLogFile(1, "Exit TDiew: " + datentime)
