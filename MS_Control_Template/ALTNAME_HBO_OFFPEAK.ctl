TITLE				            Metrolina HBO OFFPEAK Mode Choice

PROJECT_DIRECTORY	            ALT_DIR 								
NUMBER_OF_THREADS	            1													
									
TRIP_TABLE_FILE                 TripTables\HBO_OFFPEAK_TRIPS.mtx		
...
NEW_TRIP_TABLE_FILE			    ModeSplit\HBO_OFFPEAK_MS.mtx
NEW_TRIP_TABLE_FORMAT     	    TRANSCAD
SELECT_TRIP_TABLES              INCOME1, INCOME2, INCOME3, INCOME4						//---- Cores in Trip Tables ----

MODE_CONSTANT_FILE	            ModeSplit\INPUTS\HBO_OFFPEAK_Constant.txt			
MODE_BIAS_FILE	            	ModeSplit\INPUTS\HBO_OFFPEAK_Bias.txt
...
##CALIBRATION_TARGET_FILE			ModeSplit\INPUTS\Targets\HBO_Target_OFFPEAK.txt
##CALIBRATION_SCALING_FACTOR		1.0
##MAX_CALIBRATION_ITERATIONS		10
##CALIBRATION_EXIT_RMSE		    0.1
##NEW_MODE_CONSTANT_FILE			ModeSplit\Results\HBO_OFFPEAK_Constant_New.txt						
##NEW_CALIBRATION_DATA_FILE	    ModeSplit\Results\HBO_OFFPEAK_Data.txt							
##ADJUST_FIRST_MODE_CONSTANTS 	FALSE
##REPORT_AFTER_ITERATIONS			3

TRIP_PURPOSE_LABEL	            Home-Based Other
TRIP_PURPOSE_NUMBER	            3														//---- HBW = 1, HBU = 2, HBO = 3, NHB = 4 ----
...
VEHICLE_TIME_VALUES_1	       -0.01820
WALK_TIME_VALUES_1		       -0.04695
DRIVE_ACCESS_VALUES_1	       -0.01820
WAIT_TIME_VALUES_1		       -0.02730
TRANSFER_TIME_VALUES_1	       -0.03640
PENALTY_TIME_VALUES_1	       -0.01820
COST_VALUES_1                  -0.00272,     -0.00136,    -0.000735,    -0.000578 
USER_VALUES_1                  -0.02719,     -0.01363,     -0.00735,    -0.005785
...
NEW_MODE_SUMMARY_FILE           ModeSplit\Results\ALTNAME_HBO_OFFPEAK_Summary.txt
NEW_MARKET_SEGMENT_FILE         ModeSplit\Results\ALTNAME_HBO_OFFPEAK_Segment.txt
##NEW_MODE_SEGMENT_FILE           ModeSplit\Results\HBO_Mode_Seg.txt
##NEW_FTA_SUMMIT_FILE		      ModeSplit\Results\HBO_Summit.bin
NEW_PRODUCTION_FILE		        ModeSplit\Results\ALTNAME_HBO_OFFPEAK_Productions.txt
NEW_ATTRACTION_FILE		        ModeSplit\Results\ALTNAME_HBO_OFFPEAK_Attractions.txt
