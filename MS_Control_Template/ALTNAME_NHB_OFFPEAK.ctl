TITLE				            Metrolina NHB OFFPEAK Mode Choice

PROJECT_DIRECTORY	            ALT_DIR
NUMBER_OF_THREADS	            1													
									
TRIP_TABLE_FILE                 TripTables\NHB_OFFPEAK_TRIPS.mtx		
...
NEW_TRIP_TABLE_FILE			    ModeSplit\NHB_OFFPEAK_MS.mtx
NEW_TRIP_TABLE_FORMAT     	    TRANSCAD
SELECT_TRIP_TABLES              NHB_OFFPEAK						//---- Cores in Trip Tables ----

MODE_CONSTANT_FILE	            ModeSplit\INPUTS\NHB_OFFPEAK_Constant.txt			
MODE_BIAS_FILE	            	ModeSplit\INPUTS\NHB_OFFPEAK_Bias.txt
...
##CALIBRATION_TARGET_FILE			ModeSplit\INPUTS\Targets\NHB_Target_OFFPEAK.txt
##CALIBRATION_SCALING_FACTOR		1.0
##MAX_CALIBRATION_ITERATIONS		10
##CALIBRATION_EXIT_RMSE		    0.1
##NEW_MODE_CONSTANT_FILE			ModeSplit\Results\NHB_OFFPEAK_Constant_New.txt						
##NEW_CALIBRATION_DATA_FILE	    ModeSplit\Results\NHB_OFFPEAK_Data.txt							
...
##SELECT_ORIGIN_ZONES				10767	//10203
##SELECT_DESTINATION_ZONES		10725	//10601
...
NEW_MODE_SUMMARY_FILE           ModeSplit\Results\ALTNAME_NHB_OFFPEAK_Summary.txt
NEW_MARKET_SEGMENT_FILE         ModeSplit\Results\ALTNAME_NHB_OFFPEAK_Segment.txt
##NEW_MODE_SEGMENT_FILE           ModeSplit\Results\NHB_Mode_Seg.txt
##NEW_FTA_SUMMIT_FILE		      ModeSplit\Results\NHB_Summit.bin
NEW_PRODUCTION_FILE		        ModeSplit\Results\ALTNAME_NHB_OFFPEAK_Productions.txt
NEW_ATTRACTION_FILE		        ModeSplit\Results\ALTNAME_NHB_OFFPEAK_Attractions.txt
