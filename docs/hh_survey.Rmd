...
id_sub_tours <- mark_anchor %>%
  mutate(
    ...
    subtour_id2 = ifelse(max(subtour_id1, na.rm = TRUE) == 1, NA, subtour_id1),
    subtour_id3 = lag(subtour_id2),
    subtour_id4 = ifelse(subtour_id3 == 0, NA, subtour_id3),
    subtour_id = ifelse(!is.na(subtour_id4), paste0(tour_id, "_", subtour_id4), NA)
  ) %>%
  select(-c(subtour_id1:subtour_id4))
