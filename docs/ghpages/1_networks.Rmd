...
More information on coded attributes of the master roadway layer is provided [here](pdfs/MasterLayer.pdf).  In addition, the master roadway layer includes attribute descriptions within its bin file.  
